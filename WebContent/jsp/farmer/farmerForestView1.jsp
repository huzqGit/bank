...
<div style="width:100%;position:absolute;top:110px;bottom:0px;left:0px;bottom:0px">
	<div class="mini-fit">
		<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;background-color:white" 
		            url="${pageContext.request.contextPath}/farmer/loadForest.do?farmeridnum=${farmer.farmeridnum}&runitid=${farmer.runitid}"
			        ...
			        <div property="columns">
			             ...
			             <div field="owner" width="10%" headerAlign="center" allowSort="true" >使用人</div>   
