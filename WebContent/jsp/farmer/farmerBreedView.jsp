        ...
        <table style="width:100%;">
           ...
           <tr>
                ...
                <form id="query">
	            	...
	            	<span>种养殖品种：</span><input id="variety" emptyText="请输入种养殖品种" class="mini-textbox" />
   ...
   <div id="datagrid1" class="mini-datagrid" style="width:100%;height:420px" 
        ...
        >
	        <div property="columns">
	             ...
	             <div field="variety" width="60" headerAlign="center" allowSort="true" >种养殖品种</div>   
	              <div field="output" width="90" headerAlign="center" allowSort="true" >年产量</div>     
	             <div field="floorArea" width="90" headerAlign="center" allowSort="true" >占地面积</div>                            
	             <div field="outputValue" width="90" headerAlign="center" allowSort="true" >年产值</div>               
