...
public class FarmerBadLoanController {
	
	@Resource
	private IFarmerBadLoanService farmerBadLoanService;
	
	@RequestMapping(value = "/saveBadLoan",method = RequestMethod.POST)
	public ModelAndView save(HttpServletRequest request, 
		...
		if(badLoan.getId()!=null){
			...
			farmerBadLoanService.save(badLoan);
		}
		String json = JSON.toJSONString(badLoan);
	...
	@RequestMapping(value="/loadAllBadLoan",method=RequestMethod.POST)
