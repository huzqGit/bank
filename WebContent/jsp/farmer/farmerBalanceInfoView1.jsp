...
<form action="/bank/farmer/typeInBalance.do" method="POST">
<table width="100%" height="60px" style="vertical-align:middle;border:1px solid #8AD3E9">
	<tr>
		<td class="labelName" width="10%"align="right" >
			<font color="red">*</font>年份:
		</td>
		<td width="10%"><input name="year" type="text"/></td>
		<td width="5%" ></td>
		<td class="labelName" width="25%"align="right" ><font color="red">*</font>农户姓名:&nbsp;&nbsp;&nbsp; <input name="farmerName" type="text"/></td>
		<td width="5%" ></td>
...
<div class="table_m" >
	...
	<tr style="font-weight:bold;color:black">
		...
		<td align="center">家庭年度总收入合计</td>
		<td align="center">家庭年度总支出合计</td>
	</tr>
	<c:forEach items="${balances}" var="balance" varStatus="status">
	<tr onclick="detail(${balance.id})">
		<td align="center">${status.index+1}</td>
		<td align="center">${balance.year}</td>
		<td align="center">${balance.farmerName}</td>
		<td align="center">${balance.farmerIdNum}</td>
		<td align="center">${balance.totalIncome}</td>
		<td align="center">${balance.totalPay}</td>
	</tr>	
	</c:forEach>
</table>
</div>
...
function detail(id){
	window.location.href="/bank/farmer/loadBalance.do?id="+id;
}
