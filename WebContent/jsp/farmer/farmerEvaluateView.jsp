   ...
   <div id="datagrid1" class="mini-datagrid" style="width:100%;height:420px" 
        ...
        >
	        <div property="columns">
	             ...
	             <div field="neighborStatus" width="90" headerAlign="center" allowSort="true" >邻里团结情况</div> 
	             <div field="legalStatus" width="90" headerAlign="center" allowSort="true" >是否遵纪守法</div>              
	             <div field="welfareStatus" width="90" headerAlign="center" allowSort="true" >对公益事业关心程度</div> 
	             <div field="honestStatus" width="90" headerAlign="center" allowSort="true" >是否诚实守信</div> 
	             <div field="otherStatus" width="90" headerAlign="center" allowSort="true" >其他</div> 
