...
function downLoadExcel(){
	window.location.href = '/bank/jsp/cooperation/model/DebtInfoModel.xlsx';
}
function validate(){
...
<body>
<div class="file-box">
<form action="/bank/economy/debt/loadFile.do" method="post" enctype="multipart/form-data" onsubmit="return validate();">
    ...
    <tr>
        <td>
            <div >
                <ol>
                	<li>
                        	请先<a href="/bank/jsp/cooperation/model/DebtInfoModel.xlsx"><font color="red">下载模板</font></a>后,在模板内进行操作
                    </li>
                    <li>
