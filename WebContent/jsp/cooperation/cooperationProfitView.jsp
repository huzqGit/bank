 ...
 <div class="mini-toolbar" style="padding-top:5px;border-bottom:0;">
                ...
                <td style="white-space:nowrap;">
	                <form id="query" action="" class="queryPane" method="post">
		            	<span>组织机构编码：</span><input id="organcode" name="organcode" emptyText="请输入机构编码" class="mini-textbox" />&nbsp;
		             	<span>创建人：</span><input id="recoder" name="recoder" emptyText="请输入创建人" class="mini-textbox" />&nbsp;
  ...
  <div id="datagrid1" class="mini-datagrid" style="width:100%;height:90%" 
	        ...
	        <div property="columns">
				...
				<div field="recodertime" width="120" headerAlign="center" allowSort="true" >记录时间</div>               
	         </div>
	     </div>
	</div>
</div>
   <script type="text/javascript">
	  ...
	  function onSearch() {
		  ...
		  var recoder=mini.get("recoder").getValue();
		  ...
		  var json = {cooperationname:cooperationname,organcode:organcode,recoder:recoder,recordTimeBegin:recordTimeBegin,recordTimeEnd:recordTimeEnd};
