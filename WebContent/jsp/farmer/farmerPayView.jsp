   ...
   <div id="datagrid1" class="mini-datagrid" style="width:100%;height:420px" 
        ...
        >
	        <div property="columns">
	             ...
	             <div field="medicalPay" width="90" headerAlign="center" allowSort="true" >医疗支出</div> 
	             <div field="insuredPay" width="90" headerAlign="center" allowSort="true" >教育支出</div>
	             <div field="otherPay" width="90" headerAlign="center" allowSort="true" >其他支出</div>                             
	             <div field="totalPay" width="90" headerAlign="center" allowSort="true" >总支出</div>                 
