...
<div class="queryPane">
<form action="/bank/economy/importCooperation.do" method="post" enctype="multipart/form-data" onsubmit="return validateSubmit();">
<table width="100%">
	<tr>
...
<c:choose>
	<c:when test="${empty msgs}">
		<fieldset style="width:90%;margin:auto auto;border:1px solid orange">
			...
			<div style="width:100%;height:20px;">
			                <ol>
			         			<li>(1)数据采集小组使用标准模版<a href="/bank/jsp/cooperation/model/cooperation.xlsx"><font color="red">基本信息</font></a>采集数据后导入系统。</li>
			                    <li>
			                        (2)其他部门及金融机构使用自己系统导出的文件将数据导入系统。
			                    </li>
			                    <li>(3)经济合作组织名称不能为空。</li>
			                    <li>(4)营业执照不能为空。</li>
			                    <li>(5)注册日期必须为日期格式，如:2015-06-12。</li>
			                    <li>(6)导入文件数据比较大时、可能需要等待一段时间。</li>
			                </ol>
	...
	<c:otherwise>
		<div style="width:90%;margin-top:20px;margin-left:auto;margin-right:auto">
			<table  id="tips" width="90%" border="1" cellspacing=0 cellpadding=0 >
