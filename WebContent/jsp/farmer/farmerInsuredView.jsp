...
<div class="mini-toolbar" style="padding-top:5px;border-bottom:0;">
        <table style="width:100%;">
       		...
       		<tr>
       			<td>
       			<a class="mini-button" iconCls="icon-add" plain="true"  target ="_self" href="/bank/jsp/farmer/farmerInsuredForm.jsp">新增</a>
           ...
           <tr>
                ...
                <form id="query">
	            	...
	            	<span>参保人姓名：</span><input id="name" emptyText="请输入参保人姓名" class="mini-textbox">
	            	<span>参加保险种类：</span><input id="type" emptyText="请输入参加保险种类" class="mini-textbox">			
   ...
   <div id="datagrid1" class="mini-datagrid" style="width:100%;height:420px" 
            url="${pageContext.request.contextPath}/farmer/loadAllInsured.do" idField="id"
        ...
        >
	        <div property="columns">
	             ...
	             <div field="name" width="60" headerAlign="center" allowSort="true" >参保人姓名</div>   
	             <div field="type" width="90" headerAlign="center" allowSort="true" >被参加保险种类</div>     
	             <div field="amount" width="90" headerAlign="center" allowSort="true" >参保金额</div>                            
	             <div field="insureTime" width="90" headerAlign="center" dateFormat="yyyy-MM-dd" allowSort="true" >参保时间</div> 
	             <div field="limitTime" width="90" headerAlign="center" dateFormat="yyyy-MM-dd" allowSort="true" >参保到期日</div>              
  ...
  <script type="text/javascript">
	  ...
	  function onActionRenderer(e) {
          var record = e.record;
          var id = record.id;
          var s = '<a class="New_Button" target="_self" href="/bank/jsp/farmer/farmerInsuredForm.jsp?id='+id+'">[查看]</a>';      
          return s;
      }
   </script> 
</body>
