...
<div class="mini-toolbar" style="padding-top:5px;border-bottom:0;">
        <table style="width:100%;">
       		...
       		<tr>
       			<td>
       			<a class="mini-button" iconCls="icon-add" plain="true"  target ="_self" href="/bank/jsp/farmer/farmerForestForm.jsp">新增</a>
           ...
           <tr>
                ...
                <form id="query">
	            	...
	            	<span>林权证编号：</span><input id="houseProperty" emptyText="请输入林权证编号" class="mini-textbox" />
	            	<span>林权使用人：</span><input id="houseType" emptyText="请输入林权使用人" class="mini-textbox">
   ...
   <div id="datagrid1" class="mini-datagrid" style="width:100%;height:420px" 
            url="${pageContext.request.contextPath}/farmer/loadAllForest.do" idField="id"
        ...
        >
	        <div property="columns">
	             ...
	             <div field="cardNum" width="60" headerAlign="center" allowSort="true" >林权证编号</div>   
	              <div field="wordNum" width="90" headerAlign="center" allowSort="true" >林权字号</div>     
	             <div field="user" width="90" headerAlign="center" allowSort="true" >林权使用人</div>                            
	             <div field="useType" width="90" headerAlign="center" allowSort="true" >林权使用种类</div> 
	             <div field="area" width="90" headerAlign="center" allowSort="true" >面积</div>
	             <div field="storeNum" width="90" headerAlign="center" allowSort="true" >蓄积量</div>                             
	             <div field="timeLimit" width="90" headerAlign="center" allowSort="true" >使用权期限</div>                 
  ...
  <script type="text/javascript">
	  ...
	  function onSearch() {
		  ...
		  var cardNum =mini.get("cardNum").getValue();
		  ...
		  grid.load({farmerName:farmerName,farmerIdNum:farmerIdNum,cardNum:cardNum,
			  user:user,recorder:recorder,recordTimeBegin:recordTimeBegin,
            recordTimeEnd:recordTimeEnd});
       }
	  function onActionRenderer(e) {
          var record = e.record;
          var id = record.id;
          var s = '<a class="New_Button" target="_self" href="/bank/jsp/farmer/farmerForestForm.jsp?id='+id+'">[查看]</a>';      
          return s;
      }
   </script> 
</body>
