...
<div class="topMenu">
	<ul>
		...
		<li class="inactive">
			<a href="/bank/economy/debt/queryCooperation.do?cid=${cooperation.id}">资产负债信息</a>
		</li>
		<li class="active">
			利润及利润分配信息
		</li>
...
<table width ="100%" height="60px">
	<tr>
		...
		<td class="labelValue" width="10%">${cooperation.cooperationname }</td>
		<td class="labelName" width="10%" align="center">机构编码</td>
		<td class="labelValue" width="1%">:</td>
		<td class="labelValue" align="left">${cooperation.organcode}</td>
		<td width="1%"></td>
...
<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;background-color:white" 
           url="${pageContext.request.contextPath}/economy/profit/loadCooperationProfit.do?organcode=${cooperation.organcode}" idField="id"
	...
	function save() {
	  ...
	  function remove() {
		...
		function add(cid){
			...
			window.location.href="/bank/economy/profit/insertCooperationProfit.do?cid="+cid;
	}
