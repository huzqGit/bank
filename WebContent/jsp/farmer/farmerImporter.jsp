...
<div class="queryPane">
<form action="/bank/farmer/importFarmer.do" method="post" enctype="multipart/form-data" onsubmit="return validateSubmit();">
<table width="100%">
	<tr>
	...
	<fieldset style="width:90%;margin:auto auto;border:1px solid orange">
		<legend style="width:310px;height:74px;background:url(/bank/images/filetips.png) no-repeat"></legend>
			<div style="width:100%;height:20px;">
                <ol>
         			<li>(1)数据采集小组使用标准模版<a href="/bank/jsp/farmer/model/farmer.xls"><font color="red">户主信息</font></a>采集数据后导入系统。</li>
                    <li>(2)其他部门及金融机构使用自己系统导出的文件将数据导入系统。</li>
                    <li>(3)姓名不嫩为空。 </li>
                    <li>(4)身份证号不能为空。</li>
                    <li>(5)出生日期必须为日期格式，如：2015-05-12。</li>
                    <li>(6)文件比较大时加载时间会更长，请您耐心等待。</li>
                </ol>
