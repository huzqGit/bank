...
<div class="queryPane">
<form action="/bank/farmer/importFarmerPrivateLending.do" method="post" enctype="multipart/form-data" onsubmit="return validateSubmit();">
<table width="100%">
	<tr>
...
<c:choose>
	<c:when test="${empty msgs}">
		...
		<div style="width:100%;height:20px;">
		                <ol>
							<li>数据采集小组使用标准模版<a href="/bank/jsp/farmer/model/farmerPrivateLending.xls"><font color="red">民间借贷信息</font></a>采集数据后导入系统。</li>
		                    <li>
		                                                                                  其他部门及金融机构使用自己系统导出的文件将数据导入系统
		                    </li>
		                    <li>
