...
<div class="queryPane">
<form action="/bank/farmer/importFarmerInsured.do" method="post" enctype="multipart/form-data" onsubmit="return validateSubmit();">
<table width="100%">
	<tr>
...
<c:choose>
	...
	<div style="width:100%;height:20px;">
	                <ol>
	               	<li>数据采集小组使用标准模版
		               	<a href="/bank/jsp/farmer/model/farmerInsured.xls">
		               	<font color="red">参保信息</font>
		               	</a>采集数据后导入系统。
	               	</li>
	                <li>
