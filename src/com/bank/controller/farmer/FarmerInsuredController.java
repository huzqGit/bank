...
public class FarmerInsuredController {
	...
	public ModelAndView save(HttpServletRequest request, 
		...
		FarmerInsured farmer = (FarmerInsured) JSON.toJavaObject(jsb, FarmerInsured.class);
		if(farmer.getId()!=null){
			farmerInsuredService.update(farmer);
		}else{
			farmerInsuredService.save(farmer);
		}
	...
	public ModelAndView loadCompany(@RequestParam(value="id",required=true) String id, 
		...
		if(!StringUtils.isEmpty(id)){
			...
			FarmerInsured farmer = farmerInsuredService.findByPK(insuredId);
