...
<tr>
    ...
    <td style="width:40%">
    	<input name="houseProperty" class="mini-textbox" value="${house.houseProperty}" style="width:90%"/>
    </td>
...
<tr>
    ...
    <td style="width:40%">
    	<input name="buildDate" class="mini-datepicker" value="${house.buildDate}" style="width:90%"/>
	</td>
...
<tr>
    ...
    <td style="width:40%">
        <input name="useType" class="mini-textbox" value="${forest.useType}" 
        	required="true" requiredErrorText="不能为空" style="width:90%"/>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td style="width:10%"><label for="textbox1$text"><font color="red">*</font>当前评估价格:</label></td>
    <td style="width:40%">
    	<input name="assessPrice" class="mini-textbox" value="${forest.assessPrice}" 
    		required="true" requiredErrorText="不能为空" style="width:90%"/>
   	</td>
</tr>
</table>
...
<tr>
    ...
    <td style="width:40%">
   		<input id="textbox1"  name="assessPrice" class="mini-textbox" value="${device.assessPrice}" style="width:90%"
   			required="true" requiredErrorText="当前评估价格不能为空" minValue="0" maxValue="9999999"/>
    </td>
</tr>
</table>
</td></tr></table>
