...
<input name="sourcecode" class="mini-hidden"  value="${house.sourcecode}" />
<input name="sourcename" class="mini-hidden"  value="${house.sourcename}" />
<input name="runitid" class="mini-hidden"  value="${house.runitid}" />
<input name="runitname" class="mini-hidden"  value="${house.runitname}" />
