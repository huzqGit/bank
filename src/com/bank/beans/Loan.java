...
public class Loan extends BaseEntity<Long> {
	...
	public void setLimitDate1(String limitDate1) {
		this.limitDate1 = limitDate1;
	}
	...
	public String getGuaranteeType1() {
		return guaranteeType1;
	}

	public void setGuaranteeType1(String guaranteeType1) {
		this.guaranteeType1 = guaranteeType1;
	}

	public String getFloatScope() {
		return floatScope;
	}

	public void setFloatScope(String floatScope) {
		this.floatScope = floatScope;
	}
