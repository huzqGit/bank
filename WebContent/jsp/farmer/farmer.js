...
function FarmerMember(index,fid){
	var str="<div id=\"farmerMember"+index+"\"class=\"farmerMember\" method=\"POST\">"
	    +"<input class=\"mini-hidden\" name=\"members["+index+"].id\" id=\"member_id"+index+"\"/>"
	    +"<input class=\"mini-hidden\" name=\"members["+index+"].farmerId\" value=\""+fid+"\"/>"
	    ...
	    +"<td style=\"width:39%\">"
	    +"<input name=\"members["+index+"].name\" class=\"mini-textbox\" required=\"true\""
	    +"requiredErrorText=\"家庭成员姓名不能为空\" style=\"width:90%\"/>"
	    +"</td>"
	    +"<td style=\"width:10%\"><label for=\"textbox2$text\"><font color=\"red\">*</font>与户主关系:</label></td>"
	    +"<td style=\"width:39%\" >"
	    +"<input name=\"members["+index+"].relation\" class=\"mini-combobox\" required=\"true\""
	    ...
	    +"<td style=\"width:39%\">"
	    +"<input id=\"textbox1\"  name=\"members["+index+"].idNum\" class=\"mini-textbox\" required=\"true\""
	    +"requiredErrorText=\"身份证号不能为空\" style=\"width:90%\"/>"
	    +"</td>"
	    +"<td style=\"width:10%\"><label for=\"textbox2$text\"><font color=\"red\">*</font>文化程度:</label></td>"
	    +"<td style=\"width:39%\" >"
	    +"<input name=\"members["+index+"].education\" class=\"mini-combobox\" required=\"true\""
	    ...
	    +"<td style=\"width:39%\" >"
	    +"<input id=\"textbox2\"  name=\"members["+index+"].sex\" class=\"mini-combobox\" required=\"true\""
	    ...
	    +"<td style=\"width:39%\">"
	    +"<input id=\"textbox1\"  name=\"members["+index+"].marryStatus\" class=\"mini-combobox\" required=\"true\""
	    ...
	    +"<td style=\"width:39%\" >"
	    +"<input id=\"textbox2\"  name=\"members["+index+"].occupation\" class=\"mini-textbox\" required=\"true\""
	    +"requiredErrorText=\"职业不能为空\"  style=\"width:90%\"/>"
	    +"</td>"
	    +"<td style=\"width:10%\"><label for=\"textbox1$text\"> 职务:</label></td>"
	    +"<td style=\"width:39%\">"
	    +"<input id=\"textbox1\"  name=\"members["+index+"].job\" class=\"mini-textbox\" required=\"true\""
	    ...
	    +"<td style=\"width:39%\">"
	    +"<input id=\"textbox1\"  name=\"members["+index+"].phone\" class=\"mini-textbox\" required=\"true\""
...
function FarmerIncome(index,fid){
	var str="<div id=\"farmerIncome"+index+"\" class=\"farmerIncome\" method=\"POST\">"
        +"<input name=\"incomes["+index+"].id\" class=\"mini-hidden\" />"
        +"<table border=\"0\" cellpadding=\"1\" cellspacing=\"15\" width=\"100%\" >"
        +"<tr>"
        +"<td>"
        +"<table width=\"100%\" >"
        +"<tr>"
	    +"<td rowspan=\"2\" width=\"2%\" align=\"center\"><input id=\"delIncome"+index+"\" type=\"button\" onclick=\"delIncome("+index+","+fid+")\" value=\"×\"/></td>"
        +"<td style=\"width:12%\"><label for=\"textbox1$text\">家庭收入来源:</label></td>"
        +"<td style=\"width:38%\">"
        +"<input id=\"textbox1\"  name=\"incomes["+index+"].incomeType\" class=\"mini-combobox\" required=\"true\""
        ...
        +"<td style=\"width:38%\" >"
        +"<input id=\"textbox2\"  name=\"incomes["+index+"].incomeName\" class=\"mini-textbox\" required=\"true\""
        ...
        +"<td style=\"width:38%\">"
        +"<input id=\"sp1\" name=\"incomes["+index+"].netIncome\" class=\"mini-spinner\"  minValue=\"0\""
...
function FarmerInsured(index){
	var str="<form id=\"farmerInsured"+index+"\" class=\"farmerInsured\" action=\"/bank/company/save.do\" method=\"POST\">"
	+"<input name=\"id\" class=\"mini-hidden\"/>"
	+"<table border=\"0\" cellpadding=\"1\" cellspacing=\"15\" width=\"100%\">"
	+"<tr><td>"
	+"<table width=\"100%\">"
	...
	+"<td style=\"width:40%\">"
	+"<input id=\"textbox1\"  name=\"amount\" class=\"mini-spinner\" required=\"true\""
	+"requiredErrorText=\"保险金额不能为空\" minValue=\"0\" style=\"width:90%\"/>"
	+"</td>"
	+"</tr>"
	+"<tr>"
