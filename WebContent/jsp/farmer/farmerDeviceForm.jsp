...
<div id="form1" style="width:90%;margin:auto auto">
	...
	<legend><label>农户主要设备设备情况基本信息</label></legend>
	...
	<tr>
	<td style="width:10%"><label for="textbox1$text">设备名称:</label></td>
	<td style="width:40%">
	<input id="textbox1"  name="name" class="mini-textbox" required="true" 
		requiredErrorText="设备名称不能为空"style="width:90%"/>
	</td>
	<td style="width:10%"><label for="textbox2$text">品牌型号:</label></td>
	<td style="width:40%" >
	<input id="textbox2"  name="brand" class="mini-textbox" required="true" 
		requiredErrorText="品牌型号不能为空" style="width:90%"/>
	</td>
	</tr>
	<tr>
	<td style="width:10%"><label for="textbox1$text">购建价格:</label></td>
	<td style="width:40%">
	<input id="textbox1"  name="buyingPrice" class="mini-textbox" required="true" 
		requiredErrorText="购建价格不能为空" style="width:90%"/>
	</td>
	<td style="width:10%"><label for="textbox1$text">购进年份:</label></td>
	<td style="width:40%">
	<input id="textbox1"  name="buyingDate" class="mini-datepicker" required="true" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$.ajax({
		    url: "${pageContext.request.contextPath}/farmer/loadDevice.do",
		    type: "post",
		    data:{id:"${param.id}"},
	...
	function submitForm() {
	    ...
	    $.ajax({
	        url: "${pageContext.request.contextPath}/farmer/saveDevice.do",
	        type: "post",
	        data: { formData: json},
