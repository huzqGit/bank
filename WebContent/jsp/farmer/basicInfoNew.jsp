                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <select name="politicStatus" style="width:90%">
...
<tr>
<td>
    <div id="farmerMember1" style="width:100%">
                ...
                <td colspan="4" style="width:100%">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%" >
                                        <select  name="relation"  style="width:90%">
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="idNum" type="text" required="true"
                                    ...
                                    <td style="width:40%" >
                                        <select name="education" style="width:90%">
											...
											<option value="4">中等专业学校或中等技术学校</option>
                                ...
                                <tr>
                                    <td style="width:10%"><label for="textbox1$text">  婚姻状况:</label></td>
                                    <td style="width:40%">
                                        <select name="marryStatus" style="width:90%">
                                        	<option value="1">已婚</option>
											<option value="2">离异/丧偶无子女</option>
											<option value="3">离异/丧偶有子女</option>
                                    ...
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="occupation" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="job" type="text" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%" >
                                        <textarea  id="textbox2"  name="incomeName" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="productPay" type="text" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox2$text">生活支出:</label></td>
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="livingPay" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:10%"><label for="textbox1$text">医疗支出:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="medicalPay" type="text" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">教育支出:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="educatePay" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:10%"><label for="textbox1$text">参保支出:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="insuredPay" type="text" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">其他支出:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="otherPay" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:10%"><label for="textbox1$text"><font color="red">*</font>家庭年度支出总合计:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="totalPay" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="houseProperty" type="text" style="width:90%"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="houseAddress" type="text" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text"><font color="red">*</font>建筑面积:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="buildArea" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="buildPrice" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:10%"><label for="textbox1$text"><font color="red">*</font>占地面积:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="floorArea" type="text" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text"><font color="red">*</font>当前评估价格:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="assessPrice" type="text" style="width:90%"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="cardNum" type="text" required="true"
                                               requiredErrorText="林权证编号不能为空"style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox2$text">林权字号:</label></td>
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="wordNum" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="user" type="text" required="true"
                                               requiredErrorText="林权使用人不能为空" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">林权使用种类:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="useType" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="area" type="text" required="true"
                                               requiredErrorText="面积不能为空" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">蓄积量:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="storeNum" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="timeLimit" type="text" required="true"
                                               requiredErrorText="使用权期限不能为空" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">当前评估价格:</label></td>
                                    <td style="width:40%">
                                        <input id="textbox1"  name="assessPrice" type="text" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="bank" type="text" required="true"
                                               requiredErrorText="贷款金融机构不能为空"style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox2$text">业务类别:</label></td>
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="businessType" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="loanUse" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="loanBalance" type="text" required="true"
                                               requiredErrorText="当前评估价格不能为空" style="width:90%"/>
                                    </td>
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="balance" type="text" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="name" type="text" required="true"
                                               requiredErrorText="被担保人姓名不能为空"style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox2$text">被担保人身份证号:</label></td>
                                    <td style="width:40%" >
                                        <input id="textbox2"  name="idNum" type="text" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="limitTime" type="text" required="true"
                                               requiredErrorText="未结清担保到期日能为空" style="width:90%"/>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">未结清担保金:</label></td>
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="deposit" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <input id="textbox1"  name="amount" type="text" required="true"
                        ...
                        <div class="fieldset-body">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="personality" required="true"
                                               requiredErrorText="人品综合评价不能为空"style="width:90%">
                                        </textarea>
                                    </td>
                                    <td style="width:10%"><label for="textbox2$text">  家庭和睦情况:</label></td>
                                    <td style="width:40%" >
                                        <textarea  id="textbox2"  name="harmonyStatus" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="respectStatus" required="true"
                                               requiredErrorText="保险金额不能为空" style="width:90%">
                                        </textarea>
                                    </td>
                                    <td style="width:10%"><label for="textbox1$text">  邻里团结情况:</label></td>
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="neighborStatus" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="welfareStatus" required="true"
                                ...
                                <tr>
                                    ...
                                    <td style="width:40%">
                                        <textarea  id="textbox1"  name="otherStatus" required="true"
                                               requiredErrorText="对公益事业关心程度不能为空" style="width:90%">
                                        </textarea>
                                    </td>
                                </tr>
...
<script type="text/javascript">
  ...
  function addMember(){
		  $("#farmerMember1").clone(true).insertAfter($("#farmerMember1"));
	mini.parse();
