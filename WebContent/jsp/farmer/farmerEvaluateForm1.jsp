...
<input name="sourcecode" class="mini-hidden" value="${evaluate.sourcecode}"/>
<input name="sourcename" class="mini-hidden" value="${evaluate.sourcename}"/>
<input name="runitid" class="mini-hidden" value="${evaluate.runitid}"/>
<input name="runitname" class="mini-hidden" value="${evaluate.runitname}"/>
