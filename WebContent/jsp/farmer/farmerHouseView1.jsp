...
<div style="width:100%;position:absolute;top:110px;bottom:0px;left:0px;bottom:0px">
	<div class="mini-fit">
		<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;background-color:white" 
			url="${pageContext.request.contextPath}/farmer/loadHouse.do?farmeridnum=${farmer.farmeridnum}&runitid=${farmer.runitid}"
...
<script type="text/javascript">
	...
	function editRenderer(e) {
	    ...
	    var s = '<a class="Edit_Button" target="_self" href="/bank/farmer/editHouse.do?id='+id+'&fid='+fid+'">[编辑]</a>';      
	    return s;
	};
	function deleteRenderer(e) {
	    ...
	    var id = record.id;
	    var fid = record.farmerid;
	    var s = '<a class="New_Button" target="_self" href="/bank/farmer/deleteHouse.do?id='+id+'&fid='+fid+'">[删除]</a>';      
	    return s;
	};
</script>
</body>
